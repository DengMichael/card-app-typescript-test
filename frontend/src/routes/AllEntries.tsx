    ...
    if (entries.length == 0) {
        return (
            <section>
                ...
                dark:text-white">You don't have any cards</h1>
                <p className="text-center font-medium text-md
                dark:text-white">Let's <Link className="text-blue-400 underline underline-offset-1" to="/create">Create One</Link></p>
            </section>
        )
    }
    return (
